...
it.scoped.each = function (
  table: Global.EachTable,
  ...taggedTemplateData: unknown[]
) {
...
it.scoped.skip = function ItSkipScoped(
  testName: Global.TestName,
  fn: Global.TestFn,
  timeout?: number,
) {
